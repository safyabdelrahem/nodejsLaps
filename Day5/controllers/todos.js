...
const editExistingTodoById = async (req, res,next) => {
...
const deleteExistingTodoById = async (req, res,next) => {
    const todoId  = req.params.id; 
...
const returnTodosforSpecificUser = async (req, res,next) => {
...
const returnThePostsWithRequiredFilters = async (req, res,next) => {
    try{
